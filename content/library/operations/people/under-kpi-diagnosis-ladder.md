...
related_docs:
  ...
  - slug: diagnosing-constraints-beginner-playbook
    label: Diagnosing Constraints (Beginner)
    relation: reference
...
| **Claimed / live transfer** | Client spoke outside / via transfer — still counts as “spoke” for **Show Rate** when the lead also booked |
