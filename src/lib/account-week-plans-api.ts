...
export const TASK_SELECT =
  'id, plan_id, client_id, title, notes, tactic_tag, assignee_user_id, scheduled_for, status, completion_report, completed_at, completed_by, client_action_log_id, sort_order, created_at, updated_at';
