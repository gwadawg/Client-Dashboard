...
const CALL_FIELDS =
  'id, lead_id, client_id, call_type, called_at, status, handled_by, co_handler, recording_url, transcript_url, transcript, disposition, notes, details, appointment_id, linked_demo_appointment_id, form_submission_id, acquisition_leads(lead_name, phone)';
