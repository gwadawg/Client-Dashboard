...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = [
    ...
    'phone', 'source', 'website', 'drive_folder_url', 'funnel_url', 'brokerage_name', 'legal_business_name', 'nmls',
